      ...
      {users
        ...
        .map(element => (
          <>
            ...
            <div style={{ height: "73vh" }} className="flex flex-wrap mt-5 col-lg-12 row">
              <div className=" animatekarle wrapper col-lg-6 ">
                <p className="text-5xl font-bold py-12 pl-16 pt-20">Hi {element.name}<br /> Start Learning Today <br /> From Variety of Courses
                  <br />
                </p>
                <div className="ml-14">
